...
<!-- Mirrored from bulb-free-responsive-theme.myshopify.com/account/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 20:42:29 GMT -->
...
<head>
    ...
    <!--=================== Title ===================-->
    <title>Account &ndash; Bulb - Responsive eCommerce Electric Shop Free Shopify Theme</title>
    <!--=================== Helpers ===================-->
            ...
            <div class="row">
                <div id="login">
                    <div class="col-md-12 paira-gap-4">
                        <h1 class="margin-clear text-uppercase">Login</h1>
                    </div>
                    <div class="col-md-5">
                        <div class="row">
                            <div class="col-md-12">
                ...
                <div id="login" class="col-md-7 text-center">
                    ...
                    <a href="register.html" class="btn btn-success btn-lg">Create An Account</a>
                </div>
...
<!-- Mirrored from bulb-free-responsive-theme.myshopify.com/account/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 20:42:32 GMT -->
</html>